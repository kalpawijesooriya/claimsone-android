...
public class ColorExpListAdapterThreeWheel extends BaseExpandableListAdapter {
	Logger LOG = LoggerFactory.getLogger(ColorExpListAdapterThreeWheel.class);
	
	public ColorExpListAdapterThreeWheel(Context context,
		...
		try{
			...
			LOG.error("ColorExpListAdapterThreeWheel:10219");
			   if(e != null){
		...
		int groupPosition, int childPosition, long id) {
			...
			try{
				...
				if (!formObject.isEditable()) {
					...
					if (cb.isChecked()) {
						cb.setChecked(false);
						ExpList3_ThreeWheel.booleanprelistThreeWheel[level1GroupPosition][groupPosition][childPosition][0] = false;
						//LogFile.d("\n***", "11111");
					} else {
						cb.setChecked(true);
						ExpList3_ThreeWheel.booleanprelistThreeWheel[level1GroupPosition][groupPosition][childPosition][0] = true;
						//LogFile.d("\n***", "22222");
					}
					}
					else {
						if (cb.isChecked()) {
							cb.setChecked(false);
							ExpList3_ThreeWheel.booleanlistThreeWheel[level1GroupPosition][groupPosition][childPosition][0] = false;
							//LogFile.d("\n***", "33333");
						} else {
							cb.setChecked(true);
							ExpList3_ThreeWheel.booleanlistThreeWheel[level1GroupPosition][groupPosition][childPosition][0] = true;
							//LogFile.d("\n***", "44444");
						}
					}
				}
