...
public class ColorExpListAdapterTractor4WD extends BaseExpandableListAdapter {

	Logger LOG = LoggerFactory.getLogger(ColorExpListAdapterTractor4WD.class);
	...
	public ColorExpListAdapterTractor4WD(Context context,
		...
		try{
			...
			LOG.error("ColorExpListAdapterTractor4WD:11219");
			   if(e != null){
			...
			try{
				...
				if (!formObject.isEditable()) {
					...
					if(formObject.getisPreSelected()){  //PRE
						if (cb.isChecked()) {
							cb.setChecked(false);
							ExpList3_Tractor4WD.booleanprelistTractor4WD[level1GroupPosition][groupPosition][childPosition][0] = false;
							//LogFile.d("\n***", "11111");
						} else {
							cb.setChecked(true);
							ExpList3_Tractor4WD.booleanprelistTractor4WD[level1GroupPosition][groupPosition][childPosition][0] = true;
							//LogFile.d("\n***", "22222");
						}
					}
					else {
						if (cb.isChecked()) {
							cb.setChecked(false);
							ExpList3_Tractor4WD.booleanlistTractor4WD[level1GroupPosition][groupPosition][childPosition][0] = false;
							//LogFile.d("\n***", "33333");
						} else {
							cb.setChecked(true);
							ExpList3_Tractor4WD.booleanlistTractor4WD[level1GroupPosition][groupPosition][childPosition][0] = true;
							//LogFile.d("\n***", "44444");
						}
					}
				}
