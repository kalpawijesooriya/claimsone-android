...
public class ColorExpListAdapterHandTractor extends BaseExpandableListAdapter {
	Logger LOG = LoggerFactory.getLogger(ColorExpListAdapterHandTractor.class);
	...
	public ColorExpListAdapterHandTractor(Context context,
		...
		try{
			...
			LOG.error("ColorExpListAdapterHandTractor :11219");
			   if(e != null){
			...
			try{
				...
				if (!formObject.isEditable()) {
					...
					if(formObject.getisPreSelected()){  //PRE
						if (cb.isChecked()) {
							cb.setChecked(false);
							ExpList3_HandTractor.booleanprelistHandTractor[level1GroupPosition][groupPosition][childPosition][0] = false;
							//LogFile.d("\n***", "11111");
						} else {
							cb.setChecked(true);
							ExpList3_HandTractor.booleanprelistHandTractor[level1GroupPosition][groupPosition][childPosition][0] = true;
							//LogFile.d("\n***", "22222");
						}
					}
					else {
						if (cb.isChecked()) {
							cb.setChecked(false);
							ExpList3_HandTractor.booleanlistHandTractor[level1GroupPosition][groupPosition][childPosition][0] = false;
							//LogFile.d("\n***", "33333");
						} else {
							cb.setChecked(true);
							ExpList3_HandTractor.booleanlistHandTractor[level1GroupPosition][groupPosition][childPosition][0] = true;
							//LogFile.d("\n***", "44444");
						}
					}
				}
